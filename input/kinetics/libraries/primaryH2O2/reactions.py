...
entry(
    ...
    kinetics = ThirdBody(
        arrheniusLow=Arrhenius(A=(1e+17, 'cm^6/(mol^2*s)'), n=-1, Ea=(0, 'cal/mol'), T0=(1, 'K'), Tmin=(300, 'K'),
                         Tmax=(5000, 'K')),
        efficiencies={'N#N': 2.0, '[N]=O': 2.0, '[N]': 2.0, 'O': 5.0, '[O-][O+]=O': 8.0, '[O]': 28.8, '[O][O]': 8.0}),
    shortDesc = u"""[Konnov2015]""",
...
entry(
    ...
    Resembles https://github.com/ReactionMechanismGenerator/RMG-database/blob/master/input/kinetics/libraries
    /BurkeH2O2inArHe/reactions.py#L215, different values.""",
)
...
entry(
   ...
   longDesc = u"""Konnov (2015) https://doi.org/10.1016/j.combustflame.2015.07.014, Table 2, Reaction X13
    Also in the BurkeH2O2 library
    Reaction X6 in Burke at el. (Table III)
...
entry(
    ...
    longDesc = u"""Added from the BurkeH2O2 library
